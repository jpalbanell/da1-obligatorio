    ...
    public class PartidoResponse
    {
        ...
        public static PartidoResponse FromEntity(Partido partido)
        {
            return new PartidoResponse
            {
                ...
                EquipoLocal = partido.EquipoLocal?.Nombre ?? "Por definir",
                EquipoVisitante = partido.EquipoVisitante?.Nombre ?? "Por definir",
                Estadio = partido.Estadio?.Nombre ?? "",
                Grupo = partido.Fase == FaseTorneo.FaseGrupos ? partido.Grupo?.Etiqueta ?? "" : "-",
