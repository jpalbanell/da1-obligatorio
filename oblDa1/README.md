...
La cadena de conexión ya está configurada en `Web/appsettings.json`:
...
La carpeta `Scripts/` contiene dos respaldos de base de datos solicitados en la entrega:
...
```bash
sqlcmd -S localhost,1433 -U sa -P P4ssword -d DA1Db -i Scripts/bd_datos_prueba.sql
```
...
Corre los 489 tests MSTest desde la raíz del repositorio.
