namespace Dominio.Entidades
{
    public class Grupo
    {
        ...
        public virtual List<Partido> ListaPartidos { get; private set; } = new List<Partido>();
        public virtual List<PosicionesGrupo> ListaPosiciones { get; private set; } = new List<PosicionesGrupo>();
